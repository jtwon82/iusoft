					...
					<div class="calendar-body">
						<div class="calendar-week">
							<div class="table-basic table-basic-type3"  style="width:100%">
								<table width="100%">
									<colgroup><col width="*" />
									<col width="83" /><col width="83" /><col width="83" /><col width="83" /><col width="83" /><col width="83" /><col width="83" /><col width="83" /><col width="83" /><col width="83" /><col width="83" /><col width="83" /></colgroup>
									<thead>
										<tr class="no-head">
											<th>시간</th>
											<th>신발장</th>
