				...
				<div id="page-inner">
					...
					<article class="container-body">
						...
						<div class="calendar-by-3">
							...
							<div class="rent-tabs ">
								<a href="${ADMIN_PATH}/rent/reserve/time/15?date=<c:out value="${date}"/>" class="by-3 is-selected"><span>주경기장(배드민턴)</span></a>
								<a href="${ADMIN_PATH}/rent/reserve/time/16?date=<c:out value="${date}"/>" class="by-3"><span>탁구장</span></a>
								<a href="${ADMIN_PATH}/rent/reserve/time/17?date=<c:out value="${date}"/>" class="by-3"><span>당구장</span></a>
							</div>
						</div>
						<div class="calendar-by-3">
...
$(function(){
	$(".date-day").datepicker({
		onSelect: function(dateText, inst) {
	        ...
	        location.replace("${ADMIN_PATH}/rent/reserve/time/<c:out value='${part_cd}'/>?date=" + date );
